...
% search for data of particular cable in hashmaps
	...
	cableMass = calculateCableMass(cableLength, cableMassPerKm);
	...
	temperatureChange = heatChange / cableMass * specificHeat;
	newCableLength = calculateCableLength(cableLength, cableThermalExpansionFactor, temperatureChange)
